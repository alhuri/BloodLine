package com.gp.bloodline.Adapters;
...
import com.gp.bloodline.Adapters.SearchAdapter.ViewHolder;
import com.gp.bloodline.DataModels.Donor;
...
public class SearchAdapter extends RecyclerView.Adapter<ViewHolder> {
  ...
  public void onBindViewHolder(@NonNull final ViewHolder holder,
      final int position) {
    String str = "الاسم: " + dataSet.get(position).getName();
    str += "\nالمدينة: " + dataSet.get(position).getCity();
