package com.gp.bloodline.Activities;
...
import com.gp.bloodline.R;
import com.gp.bloodline.Utils.Endpoints;
import com.gp.bloodline.Utils.VolleySingleton;
...
public class RegisterActivity extends AppCompatActivity {
  ...
  private boolean isValid(String name, String city, String blood_group, String password,
    ...
    valid_blood_groups.add("O-");
    if (name.isEmpty()) {
      showMessage("الاسم فارغ");
      return false;
    } else if (city.isEmpty()) {
      showMessage("اسم المدينة مطلوب");
      return false;
    } else if (!valid_blood_groups.contains(blood_group)) {
      showMessage("اختر فصيلة دم من الاتي: " + valid_blood_groups);
      return false;
    } else if (mobile.length() != 10) {
      showMessage("يجب ان يكون رقم الهاتف مكون من 10 خانات");
      return false;
    }
    return true;
  }
